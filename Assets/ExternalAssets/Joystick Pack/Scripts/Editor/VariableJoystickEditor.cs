...
public class VariableJoystickEditor : JoystickEditor
{
    ...
    private SerializedProperty _idleStateTransparency;
    ...
    protected override void OnEnable()
    {
        ...
        _idleStateTransparency = serializedObject.FindProperty("_idleStateTransparency");
    }
    ...
    protected override void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(_idleStateTransparency, new GUIContent("Idle State Transparency", "The transparency of joystick when it in idle state"));
    }
}