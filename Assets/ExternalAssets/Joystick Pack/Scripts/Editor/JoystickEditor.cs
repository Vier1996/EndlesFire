...
public class JoystickEditor : UnityEditor.Editor
{
    ...
    private SerializedProperty joystickGroup;
    ...
    protected virtual void OnEnable()
    {
        ...
        joystickGroup = serializedObject.FindProperty("joystickGroup");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(joystickGroup, new GUIContent("Joystick group", ""));
    }
