    ...
    public class ETFXProjectileScript : MonoBehaviour
    {
        ...
        {	
            ...
            if (transform.GetComponent<Rigidbody>().useGravity)
                direction += Physics.gravity * UnityEngine.Time.deltaTime; // Accounts for gravity if enabled
            direction = direction.normalized;

            float detectionDistance = transform.GetComponent<Rigidbody>().velocity.magnitude * UnityEngine.Time.deltaTime; // Distance of collision detection for this frame
